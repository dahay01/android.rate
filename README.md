...
[![Build Status](https://travis-ci.org/dahay01/Android-Rate.png?branch=master)](https://travis-ci.org/dahay01/Android-Rate)
...
${latest.version} is ![Maven Badges](https://maven-badges.herokuapp.com/maven-central/com.github.dahay01/android-rate/badge.svg)

```groovy
dependencies {
  compile 'com.github.dahay01:android-rate:{latest.version}'
}
```
...
Please try to move the [sample](https://github.com/dahay01/Android-Rate/tree/master/sample).
